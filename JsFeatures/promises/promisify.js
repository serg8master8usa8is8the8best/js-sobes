...
// вызываем функцию с аргументами внутри промиса и получаем последним аргументом функцию
// из этой функции берем 2 значения, которые и будут делать resolve, reject 
